...
## 🔐 सुरक्षित व्यवस्थापक प्रमाणीकरण (Secure Admin Authentication)

- **प्रमाणीकरण प्रणाली**: सुरक्षित MongoDB डेटाबेस, `bcrypt` पासवर्ड हॅशिंग, आणि ब्रूट-फोर्स सुरक्षा (५ चुकीच्या प्रयत्नांनंतर १५ मिनिटे तात्पुरता लॉक).
- **पासवर्ड रीसेट**: 'Forgot Password' द्वारे १५ मिनिटांचा सुरक्षित सिंगल-युज SHA-256 हॅश टोकन ईमेलवर पाठवला जातो.
- **प्रारंभिक सेटअप**: सर्व्हर पर्यावरण चलांमधून (`.env` मधील `ADMIN_INITIAL_EMAIL` आणि `ADMIN_INITIAL_PASSWORD`) प्रथमच सीड केले जाते व डेटाबेसमध्ये केवळ `passwordHash` साठवला जातो. स्त्रोत कोडमध्ये पासवर्ड कधीही उघडा राहत नाही.
